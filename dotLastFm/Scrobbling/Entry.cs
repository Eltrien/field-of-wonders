...
namespace dotLastfm.Scrobbling
{
	...
	public class Entry
	{
		...
		public dotLastfm.Services.Track GetInfo(Session session)
		{
			return new dotLastfm.Services.Track(this.Artist, this.Title, session);
		}
	}
}
