...
namespace dotLastfm.Services
{
	...
	IHasWeeklyTrackCharts, IHasURL
	{
		...
		/// <see cref="dotLastfm.Services.WeeklyChartTimeSpan"/>.
		/// </summary>
		/// <param name="span">
		/// A <see cref="WeeklyChartTimeSpan"/>
		/// </param>
		...
		/// <summary>
		/// Returns the weekly album chart for this group in the given <see cref="dotLastfm.Services.WeeklyChartTimeSpan"/>.
		/// </summary>
		/// <param name="span">
		/// A <see cref="WeeklyChartTimeSpan"/>
		/// </param>
