...
namespace dotLastfm
{
	...
	/// if you create an <see cref="dotLastfm.Artist"/> object with an authenticated session and
	...
	public class Session : IEquatable<Session>
	{
		...
		{
			XmlDocument doc = (new dotLastfm.Services.Request("auth.getToken", this, new RequestParameters())).execute();
